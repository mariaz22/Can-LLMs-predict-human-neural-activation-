...
def listen_to(candidate, stimulus_set, reset_column='story', average_sentence=True):
    ...
    """
    default_layer = model_layers[candidate.identifier][-1]
    activations = []
    for story in ordered_set(stimulus_set[reset_column].values):
        ...
        story_activations = candidate(stimuli=story_stimuli, layers=[default_layer],  average_sentence=average_sentence)
